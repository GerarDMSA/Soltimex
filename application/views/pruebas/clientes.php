...
<div class="container">
            ...
            <div class="panel panel-default">
                <div class="panel-heading c-list">
                    ...
                    <ul class="pull-right c-controls">
                        <li><a href="#cant-do-all-the-work-for-you" data-toggle="tooltip" data-placement="top" title="Add Contact"><i class="glyphicon glyphicon-plus" style="color:black"></i></a></li>
                         <li><a href="#borrar" data-toggle="tooltip1" data-placement="top" title="Delete Contact"><i class="glyphicon glyphicon-minus" style="color:black"></i></a></li>
                        <li><a href="#" class="hide-search" data-command="toggle-search" data-toggle="tooltip" data-placement="top" title="Toggle Search" style="color:black"><i class="fa fa-ellipsis-v"></i></a></li>
                    </ul>
                </div>
                    ...
                    <div class="col-xs-12">
                        <div class="input-group c-search">
                            ...
                            <span class="input-group-btn">
                                <button class="btn btn-default" type="button"><span class="glyphicon glyphicon-search text-muted" style="color:black"></span></button>
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <ul class="list-group" id="contact-list">
                    <li class="list-group-item">
                        <div class="col-xs-12 col-sm-3">
                            <a href="<?php echo base_url("/index.php/Cursos/perfil");?>" ><img src="http://api.randomuser.me/portraits/men/49.jpg" alt="Scott Stevens" class="img-responsive img-circle" />
                                </a>
                        </div>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="mySmallModalLabel">Agregar nuevo Cliente</h4>
                </div>
                <div class="modal-body">
                    <form >
                        ...
                        <input type="text" placeholder="Departamento"><br>
                        <label>Teléfonos de Contacto</label><br>
                        <input type="tel" placeholder="Telefono #1">
                        <input type="tel" placeholder="Telefono #2">
                        <input type="tel" placeholder="Telefono Celular"><br>
                        <label>E-mails de Contacto</label><br>
                        <input type="email" placeholder="Personal"><br>
                        <input type="email" placeholder="Empresa"><br>
    ...
    <div id="borrar" class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
