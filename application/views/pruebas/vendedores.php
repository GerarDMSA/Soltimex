...
<div class="container">
                ...
                <div class="panel-heading c-list">
                    ...
                    <ul class="pull-right c-controls">
                        <li><a href="#cant-do-all-the-work-for-you" data-toggle="tooltip" data-placement="top" title="Add Contact"><i class="glyphicon glyphicon-plus" style="color:black"></i></a></li>
                         <li><a href="#cant-do-all-the-work-for-you" data-toggle="tooltip" data-placement="top" title="Delete Contact"><i class="glyphicon glyphicon-minus" style="color:black"></i></a></li>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <span>No se si agregara mas vendedores</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="<?php echo base_url("//rawgithub.com/stidges/jquery-searchable/master/dist/jquery.searchable-1.0.0.min.js"); ?>"/></script>